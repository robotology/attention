...
bool egocentricAudioCropperModule::configure(ResourceFinder &rf) {
...
bool egocentricAudioCropperModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}

bool egocentricAudioCropperModule::close() {
...
bool egocentricAudioCropperModule::respond(const Bottle& command, Bottle& reply)
{
...
bool egocentricAudioCropperModule::updateModule()
{
    return true;
}

double egocentricAudioCropperModule::getPeriod()
{
