 ...
 * 21/12/10 : vergence only after the robot has kept the fixation point with the cyclopic eye       <b>author:Rea<\b> \n
 * 04/01/11 : changed the algorithm that translates the vergence event into a saccadic event        <b>author:Rea<\b> \n
 * 04/01/11 : added flag that discriminates between vergence after a mono saccadic event            <b>author:Rea<\b> \n
 * 06/01/11 : added new check to avoid situation in which the saccadic event stuck                  <b>author:Rea<\b> \n
 * 10/01/11 : changed the fixation command after monoLeft from absolute to monoLeft fixed image     <b>author:Rea<\b> \n
 * 18/01/11 : introduced the right eye image as input of the vergence algorithm                     <b>author:Rea<\b> \n
 * 26/01/11 : added resume/suspend and port for status communication                                <b>author:Rea<\b> \n
 * 31/01/11 : checkpoint that controls whether there is a action performing and waits till not      <b>author:Rea<\b> \n
 * 01/02/11 : added xoffset, yoffset and zoffset for 3D target                                      <b>author:Rea<\b> \n
 * 30/02/11 : added new parameters for input image dimensioning                                     <b>author:Rea<\b> \n
 * 30/02/11 : removed imprecision in the case the tracker does not initialise                       <b>author:Rea<\b> \n
 * 24/04/11 : added fixed neck pitch option                                                         <b>author:Rea<\b> \n
 * 28/03/11 : added the limits for the allowed fixation points in 3d space                          <b>author:Rea<\b> \n
 * 29/03/11 : added new parameters to the config file and embedded previously added ones            <b>author:Rea<\b> \n
 * 06/04/11 : added a new port for acquiring the template and sending it to the objectsColl.        <b>author:Rea<\b> \n
 * 11/04/11 : introduced boolean flag for allowing refinement of the final position                 <b>author:Rea<\b> \n
 * 11/04/11 : new limit for avoiding the robot to attend too close to the body                      <b>author:Rea<\b> \n
 * 16/04/11 : moved the execution at the beginning of saccade and the table not vergence accompli   <b>author:Rea<\b> \n
 * 16/04/11 : plotted the texture on the small pciture in the GUI                                   <b>author:Rea<\b> \n
 * 16/04/11 : added original context restore                                                        <b>author:Rea<\b> \n
 * 05/05/11 : added the mapping between the dvs camera and the original dimension in the eyes       <b>author:Rea<\b> \n
 * 20/05/11 : put together the command for choosing between onDvs and onHead                        <b>author:Rea<\b> \n
 * 03/06/11 : added new output image where the area around WTA is selected                          <b>author:Rea<\b> \n
 * 09/06/11 : added the port in order to plot out the timing of the whole fixation deployment       <b>author:Rea<\b> \n
