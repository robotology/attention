...
bool selectiveAttentionModule::respond(const Bottle &command,Bottle &reply){
    ...
    case COMMAND_VOCAB_HELP:
        rec = true;
        {
            ...
            reply.addString("set kc3 <double> \t: setting of linear combination coefficient (mapc3)  ");
            ...
            reply.addString("get kc3 <double> \t: getting of linear combination coefficient (mapc3)  ");
