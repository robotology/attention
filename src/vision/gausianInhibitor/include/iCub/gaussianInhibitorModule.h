...
#ifndef ATTENTION_SEGMENTINHIBITORMODULE_H
#define ATTENTION_gaussianINHIBITORMODULE_H
...
class gaussianInhibitorModule : public RFModule  {

    string moduleName;
    string handlerPortName;
    RpcServer handlerPort;

    gaussianInhibitorThread* pThread;
...
#endif //ATTENTION_SEGMENTINHIBITORMODULE_H
