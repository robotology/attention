...
class batchAnalysis2Thread : public yarp::os::Thread {
private:
    int width, height;
    ...
    yarp::os::BufferedPort<yarp::os::Bottle>  outputPortTime;      // name of output port for the time
    yarp::os::Bottle timeBottle;                                   // name of the boottle with float
    yarp::os::Bottle contentBottleTime;                                 // name of the bottle with list of float

    double timeDiffOF;
    double timeDiffThresholding;
    double timeDiffProcessing;

    std::string foldername;
    std::string resultnameJPG;
    std::string resultnameXML;
    char numbername1 [50];
    char numbername2 [50];
    int k;
    int number1;
...
public:
    ...
    * constructor default
    */
    batchAnalysis2Thread();

    /**
    * constructor 
    * @param robotname name of the robot
    */
    batchAnalysis2Thread(std::string robotname,std::string configFile);
