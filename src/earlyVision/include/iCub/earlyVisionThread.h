...
private:
    ...
    // To check log-Gabor
    yarp::sig::ImageOf<yarp::sig::PixelRgb> *logGaborImg;
    yarp::sig::ImageOf<yarp::sig::PixelFloat>* logGaborOutImg;
    yarp::os::BufferedPort<yarp::sig::ImageOf<yarp::sig::PixelRgb> > logGabPortIn;
    yarp::os::BufferedPort<yarp::sig::ImageOf<yarp::sig::PixelFloat> > logGabPortOut;
