...
const int32_t COMMAND_VOCAB_M45 VOCAB4('o','M','4','5')
...
static void cb_w0_scale( GtkAdjustment *adj ) {
    ...
    if (_pOutPort!=NULL) {
        ...
        bot.addVocab32(COMMAND_VOCAB_HOR);
...
static void cb_w1_scale( GtkAdjustment *adj ) {
    ...
    if (_pOutPort!=NULL) {
        ...
        bot.clear();
        bot.addVocab32(COMMAND_VOCAB_SET);
        bot.addVocab32(COMMAND_VOCAB_45);
        bot.addFloat32((double) adj->value);
        _pOutPort->write(bot,in);
    }
}
...
static void cb_w2_scale( GtkAdjustment *adj ) {
    ...
    if (_pOutPort!=NULL) {
        ...
        bot.clear();
        bot.addVocab32(COMMAND_VOCAB_SET);
        bot.addVocab32(COMMAND_VOCAB_VER);
        bot.addFloat32((double) adj->value);
        _pOutPort->write(bot,in);
    }
}
...
static void cb_w3_scale( GtkAdjustment *adj ) {
    ...
    if (_pOutPort!=NULL) {
        ...
        bot.clear();
        bot.addVocab32(COMMAND_VOCAB_SET);
        bot.addVocab32(COMMAND_VOCAB_M45);
        bot.addFloat32((double) adj->value);
        _pOutPort->write(bot,in);
    }
}
