...
class imageSenderModule:public yarp::os::RFModule {
    ...
    /*  */
    imageSenderRatethread *rThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
