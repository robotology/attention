...
class consumer : public yarp::os::RateThread {
private:   
	int* pSharedResource;				  //in the ratethread you should pass the pointer to the variable, not the variable itself
	int* ppSharedResource;
	yarp::os::Semaphore* pSem;			  //in the header you should put the complete path
    yarp::os::Semaphore* ppSem;

	double  timenow_consumer;
	double  timepred_consumer;
	double  timeDiff_consumer;
...
public:
    ...
    */
	...
	void setSharedResource(int* ppSharedResource);
	void setSharedSemaphore(yarp::os::Semaphore* ppSem);
