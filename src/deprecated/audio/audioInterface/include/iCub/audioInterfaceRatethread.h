...
public:
    ...
    * constructor default
    */
    audioInterfaceRatethread();

    /**
    * constructor 
    * @param robotname name of the robot
    */
    audioInterfaceRatethread(std::string robotname,std::string configFile);
