...
const int32_t COMMAND_VOCAB_M45           = yarp::os::createVocab32('o','M','4','5');
const int32_t COMMAND_VOCAB_GHOR          = yarp::os::createVocab32('g','h','o','r');
const int32_t COMMAND_VOCAB_GVER          = yarp::os::createVocab32('g','v','e','r');
const int32_t COMMAND_VOCAB_BHOR          = yarp::os::createVocab32('b','h','o','r');
const int32_t COMMAND_VOCAB_BVER          = yarp::os::createVocab32('b','v','e','r');
