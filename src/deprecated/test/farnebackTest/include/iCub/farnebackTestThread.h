...
class farnebackTestThread : public yarp::os::Thread {
private:
    int width, height;
    ...
    //int file1= sprintf(filename1, "C:/Users/AVignolo/Desktop/Acquisizioni_iCub/%8.8d.ppm", k);
    int file1;
    int file2;
    bool result;
public:
    ...
    */
    farnebackTestThread(std::string robotname,std::string configFile);
