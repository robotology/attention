...
*/
#include "iCub/allocentricAudioPriorAdderModule.h"
using namespace attention::dictionary;

bool allocentricAudioPriorAdderModule::configure(ResourceFinder &rf) {
    ...
    moduleName = rf.check("name",
                          Value("/allocentricAudioPriorAdder"),
    ...
    pThread = new allocentricAudioPriorAdderThread(moduleName);
...
bool allocentricAudioPriorAdderModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}

bool allocentricAudioPriorAdderModule::close() {
...
bool allocentricAudioPriorAdderModule::respond(const Bottle& command, Bottle& reply)
{
...
bool allocentricAudioPriorAdderModule::updateModule()
{
    return true;
}

double allocentricAudioPriorAdderModule::getPeriod()
{
