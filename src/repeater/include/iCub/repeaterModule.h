 ...
 * This file can be edited at \c $ICUB_ROOT/main/src/repeaters/repeater/include/iCub/repeater.h
 * 
 */
...
class repeaterModule:public yarp::os::RFModule {
