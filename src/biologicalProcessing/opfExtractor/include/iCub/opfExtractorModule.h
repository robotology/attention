...
/** 
 *
 * \defgroup icub_opfExtractor opfExtractor
 ...
 *
 * - \c from \c opfExtractor.ini \n 
 *   specifies the configuration file
 *
 * - \c context \c opfExtractor/conf \n
 *   specifies the sub-path from \c $ICUB_ROOT/icub/app to the configuration file
 *
 * - \c name \c opfExtractor \n 
 *   specifies the name of the opfExtractor (used to form the stem of opfExtractor port names)  
 *
 * - \c robot \c icub \n 
 ...
 *
 *  - \c /opfExtractor \n
 *    This port is used to change the parameters of the opfExtractor at run time or stop the opfExtractor. \n
 ...
 *    The port can be used by other opfExtractors but also interactively by a user through the yarp rpc directive, viz.: \c yarp \c rpc \c /opfExtractor
 *    This opens a connection from a terminal to the port and allows the user to then type in commands and receive replies.
 *       
 *  - \c /opfExtractor/image:i \n
 *
 * <b>Output ports</b>
 *
 *  - \c /opfExtractor \n
 *    see above
 *
 *  - \c /opfExtractor/image:o \n
 *
 * <b>Port types</b>
 *
 * The functional specification only names the ports to be used to communicate with the opfExtractor 
 ...
 *
 * \c opfExtractor.ini  in \c $ATTENTIO_ROOT/app/opfExtractor/conf \n
 * \c icubEyes.ini  in \c $ICUB_ROOT/app/opfExtractor/conf
 * 
 ...
 * 
 * <tt>opfExtractor --name opfExtractor --context opfExtractor/conf --from opfExtractor.ini --robot icub</tt>
 *
 * \author Rea Francesco
 *
 * Copyright (C) 2013 Robotics Brain and Cognitive Science \n
 * CopyPolicy: Released under the terms of the GNU GPL v2.0.\n
 * This file can be edited at \c $ICUB_ROOT/contrib/src/morphoGen/src/opfExtractor/include/iCub/opfExtractor.h
 * 
 */
